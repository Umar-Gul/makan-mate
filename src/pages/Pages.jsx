    ...
    >
      ...
      >
        <div style={{ maxWidth: 640, margin: "0 auto" }}>
          ...
          >
            Reservations, team bios, gallery, support — navigate every corner of
            the Makan Mate experience.
          </p>
            ...
            {pages.map((page, i) => (
              <div
                ...
                style={{
                  background: "#fff",
                  border:
                    hovered === i ? "1px solid #f0c4b6" : "1px solid #e4e4e4",
                  borderRadius: 16,
                  ...
                  boxShadow:
                    hovered === i ? "0 12px 40px rgba(201,78,45,0.09)" : "none",
